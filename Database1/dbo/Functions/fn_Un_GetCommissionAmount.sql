...
--  dbo UDF fn_Un_GetCommissionAmount
...
CREATE FUNCTION dbo.fn_Un_GetCommissionAmount
( @FTotalFee     MoMoney,
  @FCommPaid     MoMoney,
...
BEGIN
  ...
  SET @Commission = @ToPay - (dbo.fn_Un_GetAdvanceAmount(@FTotalFee, @FAdvancePaid, @ToPay) + (@FCommPaid + @FAdvancePaid))
