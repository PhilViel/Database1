...
Code du service		: fnOPER_ObtenirTypesOperationCategorie
Nom du service		: Obtenir les types d'opération d'une catégorie
But 				: Obtenir les codes des types d'opération faisant parties d'une catégorie d'opérations.
Facette				: OPER
...
Exemple d’appel		:	SELECT [dbo].[fnOPER_ObtenirTypesOperationCategorie]('IQEE-DEMANDE-COTISATION')

Paramètres de sortie:	Table						Champ							Description
		  				-------------------------	--------------------------- 	---------------------------------
						tblOPER_OperationsCategorie	cID_Type_Oper					Liste des codes des types
																					d'opération.
...
****************************************************************************************************/
CREATE FUNCTION [dbo].[fnOPER_ObtenirTypesOperationCategorie]
(
	...
	DECLARE curOperations_Categorie CURSOR FOR
		...
		FROM tblOPER_CategoriesOperation CO
		     JOIN tblOPER_OperationsCategorie OC ON OC.iID_Categorie_Oper = CO.iID_Categorie_Oper
												AND OC.cID_Type_Oper IS NOT NULL
