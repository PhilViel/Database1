...
/****************************************************************************************************
Code de service		:		fnGENE_CalculerJVMComptable_Convention
...
Exemple d'appel:
                SELECT * FROM DBO.[fnGENE_CalculerJVMComptable_Convention] (1234, 2011-12-19 07:52:45.930)
...
CREATE FUNCTION [dbo].[fnGENE_CalculerJVMComptable_Convention]
					(	
	                        @iID_Convention 				INT,
							@dtDate_Fin  				DATETIME
					)
...
SELECT @mMontant_IQEE = dbo.fnIQEE_CalculerSoldeIQEE_Convention(@iID_Convention, @dtDate_Fin)
