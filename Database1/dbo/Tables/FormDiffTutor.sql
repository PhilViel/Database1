CREATE TABLE [dbo].[FormDiffTutor] (
    [NoConvention] VARCHAR (75)  NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Table des différences sur les tuteurs dans les formulaires', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FormDiffTutor';
