CREATE TABLE [dbo].[tblCONV_DonneeReleveDepot_Lots] (
...
GO
CREATE NONCLUSTERED INDEX [IX_CONV_DonneeReleveDepot_Lots_iIDSouscripteur]
    ON [dbo].[tblCONV_DonneeReleveDepot_Lots]([iIDSouscripteur] ASC) WITH (FILLFACTOR = 90);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Table temporaire des données servant à la génération des relevés de dépôt', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'tblCONV_DonneeReleveDepot_Lots';
