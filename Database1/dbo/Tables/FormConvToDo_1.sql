CREATE TABLE [dbo].[FormConvToDo#1] (
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Table des conventions à traiter dans les formulaires', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FormConvToDo#1';
