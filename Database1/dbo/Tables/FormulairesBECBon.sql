CREATE TABLE [dbo].[FormulairesBECBon] (
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Table contenant des informations valides liées au BEC dans les formulaires', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FormulairesBECBon';
