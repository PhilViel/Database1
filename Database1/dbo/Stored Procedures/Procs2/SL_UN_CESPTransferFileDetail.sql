...
Nom                 :	SL_UN_CESPTransferFileDetail
Description         :	Renvoi le détail d'un fichier d'historique des status.
Valeurs de retours  :	Dataset
				ExternalTransfertSatutsID	Chaîne de 3 caractères identifiant le statut. 
								('30D' = 30 jours, '60D' = 60 jours, '90D' = 90 jours, 'ACC' = accepté) 
				RegimeNumber
				OterContractNumber		Numéro d'enregistrement gouvernemental du plan de la convention de 
