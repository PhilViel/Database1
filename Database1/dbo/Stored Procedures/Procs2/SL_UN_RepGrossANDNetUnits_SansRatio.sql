...
Note                :	2009-05-14	Donald Huppé	    Créaton 
                        ...
                        2018-11-08  Pierre-Luc Simard   N'est plus utilisée

exec SL_UN_RepGrossANDNetUnits NULL, '2012-11-07','2012-11-08', 0, 1
EXEC SL_UN_RepGrossANDNetUnits 490, NULL, NULL, 0, 0

exec SL_UN_RepGrossANDNetUnits NULL, '2009-01-01', '2009-12-31', 0, 0

****************************************************************************************************/
CREATE PROCEDURE [dbo].[SL_UN_RepGrossANDNetUnits_SansRatio] 
	(
