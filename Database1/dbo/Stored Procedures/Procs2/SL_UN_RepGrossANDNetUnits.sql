...
Note                :	2009-05-14	Donald Huppé	    Création 
                        ...
                        2018-11-12  Pierre-Luc Simard   Utilisation des regroupements de régimes 

exec SL_UN_RepGrossANDNetUnits_DateUnite NULL, '2017-11-21','2017-12-25', 0, 1
EXEC SL_UN_RepGrossANDNetUnits 490, NULL, NULL, 0, 0

exec SL_UN_RepGrossANDNetUnits NULL, '2016-01-01', '2016-07-27', 0, 1,12,1
...
****************************************************************************************************/
CREATE PROCEDURE [dbo].[SL_UN_RepGrossANDNetUnits] 
	(
...
BEGIN
 ...
 --PRINT '4 - ' + CAST(DATEDIFF(MILLISECOND, @dtBegin, GETDATE())/1000 AS VARCHAR(20))
	...
	GROUP BY 
		U.UnitID,
		UT.RepID,
		isnull(rc.BusinessStart, R.BusinessStart), UT.dtFirstDeposit,
		UT.BossID,
		T.RepTreatmentID
