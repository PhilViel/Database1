...
Nom                 :	RP_UN_SumContByPlanAndQualifYearAccNbr
Description         :	Procédure stockée retournant les numéros de comptes valides à une date donnée pour le rapport 
								: Sommaire des contributions par régime et année de qualification
...
*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[RP_UN_SumContByPlanAndQualifYearAccNbr] (
