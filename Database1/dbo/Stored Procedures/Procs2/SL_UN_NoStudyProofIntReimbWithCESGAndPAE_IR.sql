...
Nom                 :	SL_UN_NoStudyProofIntReimbWithCESGAndPAE_IR
Description         :	Recherche d'anomalies : Retourne les conventions avec le remboursement intégral (RIN) sans 
						preuve d’inscription, dont une ou plusieurs bourses ont été payées et pour lesquelles la 
						SCEE, la SCEE+ ou le BEC n’a pas été retourné au PCEE. Donc pour lesquelles il y a un solde 
						de SCEE, de SCEE+ ou du BEC.
...
Note                :	ADX0000746	IA	2005-07-14	Bruno Lapointe		Création
...
*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[SL_UN_NoStudyProofIntReimbWithCESGAndPAE_IR] (
...
BEGIN
    ...
    SELECT 1/0
    /*
	DECLARE @tConventionRIAndPAE TABLE (
		ConventionID INTEGER PRIMARY KEY )

	INSERT INTO @tConventionRIAndPAE
