...
Nom                 :	psREPR_RapportMortier_4Categories2018
...
Note                :	2017-03-27	Donald Huppé	Créaton (à partir de GU_RP_VentesExcelRepConcoursUnitBenef)
						2017-04-12	Donald Huppé	Pour les ajouts d'unités, faire comme le calcul d'unités brutes et nettes
						2017-05-15	Donald Huppé	Pascale Girard demande : Pour les cotisations, prendre InForceDate au lieu de Date de signature (pour faire comme dans rapport vente et nouv bénéf.
						2017-05-31	Donald Huppé	Exclure siège social de la section des cotisations
...
exec psREPR_RapportMortier_4Categories2018 '2017-01-01', '2017-09-06', 32

drop proc psREPR_RapportMortier_4Categories2018

****************************************************************************************************/
CREATE PROCEDURE [dbo].[psREPR_RapportMortier_4Categories2018] (
