...
Code du service		: psConv_RapportLettreResiliation_08_60
Nom du service		: Générer la lettre de résiliaton 08_60
But 				: 
Facette				: CONV
...
Exemple d’appel		:	EXEC psConv_RapportLettreResiliation_08_60 '2037998,U-20011219005,U-20011219006'
						EXEC psConv_RapportLettreResiliation_08_60 'R-20050225003,R-20050225005'
...
Historique des modifications:
		...
		------------	----------------------------------	-----------------------------------------	------------
		2013-08-08		Maxime Martel						Création du service	
		2013-09-25		Maxime Martel						Ajout du plan de classification				
****************************************************************************************************/
CREATE PROCEDURE [dbo].[psCONV_RapportLettreResiliation_08_60] @conv varchar(max)
AS
BEGIN
	DECLARE
	...
	SELECT 
		...
		PlanClassification = [dbo].[fnCONV_ObtenirDossierClient](c.subscriberID,1) + '\' + replace(LEFT(CONVERT(VARCHAR, @today, 120), 10),'-','') + '_le_0860'
