...
Code du service		: psCONV_RapportLettre_le_acc_res60signe
Nom du service		: Générer la lettre le_acc_res60signe
But 				: 
Facette				: CONV
...
Exemple d’appel		:	EXEC psCONV_RapportLettre_le_acc_res60signe '2037998,U-20011219005,U-20011219006', '2013-10-02'
						EXEC psCONV_RapportLettre_le_acc_res60signe 'X-20130712006', '2013-10-02'
...
****************************************************************************************************/
CREATE PROCEDURE [dbo].[psCONV_RapportLettre_le_acc_res60signe] @cConventionno varchar(max), @date date
AS
BEGIN
	DECLARE
	...
	SELECT 
		...
		+ case hs.langID when 'FRA' then '_le_acc_res-60signe' when 'ENU' then '_le_acc_res-60signe_ang' end
