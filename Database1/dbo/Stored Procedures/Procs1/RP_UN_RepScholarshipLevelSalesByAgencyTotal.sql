...
Nom                 :	RP_UN_RepScholarshipLevelSalesByAgencyTotal
Description         :	Procédure stockée du rapport : Ventes des représentants et agences par niveau de scolarité (Total agences)
...
*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[RP_UN_RepScholarshipLevelSalesByAgencyTotal](	
	...
	IF DATEDIFF(SECOND, @dtBegin, @dtEnd) > @siTraceReport
		...
		INSERT INTO Un_Trace (
			...
			SELECT
				...
				@dtBegin,
				@dtEnd,
				'Ventes des représentants et agences par niveau de scolarité (Total agences)',
				'RP_UN_RepScholarshipLevelSalesByAgencyTotal',
				'EXECUTE RP_UN_RepScholarshipLevelSalesByAgencyTotal @ConnectID = '+CAST(@ConnectID AS VARCHAR)+
