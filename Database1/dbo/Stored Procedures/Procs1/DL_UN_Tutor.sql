...
Nom                : 	DL_UN_Tutor
Description        : 	Suppression de tuteurs
Valeurs de retours : 	>0  : Tout à fonctionné
                      	<=0 : Erreur SQL
									-1 : 	Erreur à la création du log
									-2 : 	Erreur à la suppression du tuteur
									-3 : 	Le tuteur est utilisé sur un ou des bénéficiaires
...
*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[DL_UN_Tutor] (
	@ConnectID INTEGER, -- ID Unique de connexion
	@iTutorID INTEGER ) -- ID du tuteur à supprimer, correspond au HumanID.
AS
BEGIN
	DECLARE
		@iResult INTEGER,
