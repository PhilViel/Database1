...
Description         :	Rapport des Niveau et boni des représentants 2012
Valeurs de retours  :	Dataset 
Note                :	2011-02-23	Donald Huppé	Création (à partir de GU_RP_Vente_NiveauEtBoni_2011_ConcoursVersProchainNiveau)

*********************************************************************************************************************/

-- exec GU_RP_Vente_NiveauEtBoni_2012 '2011-01-01', '2011-02-23' 

CREATE procedure [dbo].[GU_RP_Vente_NiveauEtBoni_2012] 
	(
...
create table #GrossANDNetUnits (
	...
	-- Boni
	left join GUI.dbo.RepBoni2012 B24P on (round(NB.Point,0) >= B24P.pointFrom and round(NB.Point,0) < B24P.PointTo) and (round(NB.ConsPct,0) = B24P.Cons) and B24P.RepLevel = '24MoisPlus'
	left join GUI.dbo.RepBoni2012 B24M on (round(NB.Point,0) >= B24M.pointFrom and round(NB.Point,0) < B24M.PointTo) and (round(NB.ConsPct,0) = B24M.Cons) and B24M.RepLevel = '24MoisMoins'
