...
Nom                 :	psREPR_RapportBoni_2017 (GU_RP_Vente_NiveauEtBoni)
Description         :	Rapport des bonis des représentants 2017
Valeurs de retours  :	Dataset 

Exemple             :   exec psREPR_RapportBoni_2017 '2017-01-01', '2017-09-06'

Note                :	
						2017-07-06	Donald Huppé	    jira PROD-5999
...
*********************************************************************************************************************/
CREATE procedure [dbo].[psREPR_RapportBoni_2017] 
(
...
BEGIN
	...
	*/
	...
	alter table #TmpBoni add RepLevel varchar(5), Levelid int, Boni float/*, RepLevel_PourNiveau varchar(5)*/

	-- JIRA TI-4181 : André Larocque n'est pas une recrue : mettre son 1er BusinessStart de 2007 pour qu'il soit 36P
	UPDATE #TmpBoni set BusinessStart = '2007-09-21' where repID = 736892
	-- jira ti-5419 : Chantale Ouellet n'est pas un recrue : mettre son BusinessStart = 2008-02-18
	UPDATE #TmpBoni set BusinessStart = '2008-02-18' where repID = 768019

	-- jira ti-6547 : Ghislain Thibeault n'est pas un moins de 36 mois
	UPDATE #TmpBoni set BusinessStart = '2003-01-06' where repID = 719791
	...
	select 
		...
		,RepCodeInt = case when ISNUMERIC(repcode) =1 then cast(repcode as int) else 0 end
		--,RepLevel_PourNiveau
	from #TmpBoni NB
