...
Code du service		: psCONV_RapportLettre_le_Retard_Annuel (ancien psCONV_RapportLettreRetardAvisAnnuel)
Nom du service		: Générer la lettre d'avis de retard annuel (le_Retard_Annuel)
But 				: 
Facette				: CONV
...
Exemple d’appel		:	EXECUTE psCONV_RapportLettre_le_Retard_Annuel 'U-20050705006'
...
Historique des modifications:
		...
		------------	----------------------------------	-----------------------------------------	------------
		2017-08-18		Donald Huppé						Création (à partir de psCONV_RapportLettreRetardAvisAnnuel)
****************************************************************************************************/
CREATE PROCEDURE [dbo].[psCONV_RapportLettre_le_Retard_Annuel] 
(
...
BEGIN
	...
	SELECT   
		...
		PlanClassification = [dbo].[fnCONV_ObtenirDossierClient](c.subscriberID,1) + '\' + replace(LEFT(CONVERT(VARCHAR, @dateExec, 120), 10),'-','') + '_le_retard_annuel'
