...
Nom                 :	RP_UN_RepTreatmentChargeRET
Description         :	Procédure stockée du rapport : Rapport des commissions détaillés (Retenues)
Valeurs de retours  :	Dataset
Note                :	ADX0001206	IA	2007-01-09	Bruno Lapointe		Optimisation.
*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[RP_UN_RepTreatmentChargeRET] (
	@ConnectID INTEGER,
	@RepID INTEGER,
	...
	IF DATEDIFF(SECOND, @dtBegin, @dtEnd) > @siTraceReport
		...
		INSERT INTO Un_Trace (
			...
			SELECT
				...
				@dtBegin,
				@dtEnd,
				'Rapport des commissions détaillés (Retenues)',
				'RP_UN_RepTreatmentChargeRET',
				'EXECUTE RP_UN_RepTreatmentChargeRET @ConnectID = '+CAST(@ConnectID AS VARCHAR)+
