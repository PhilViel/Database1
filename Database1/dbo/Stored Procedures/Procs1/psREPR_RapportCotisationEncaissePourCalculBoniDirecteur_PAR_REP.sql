...
Code du service		: psREPR_RapportCotisationEncaissePourCalculBoniDirecteur_PAR_REP
...
Exemple d’appel		:	EXECUTE psREPR_RapportCotisationEncaissePourCalculBoniDirecteur '2016-01-01', '2016-12-31'
						EXECUTE psREPR_RapportCotisationEncaissePourCalculBoniDirecteur_PAR_REP '2018-01-01', '2018-01-31'

Historique des modifications:
		Date			Programmeur			Description									Référence
		------------	------------------- -----------------------------------------	------------
		2018-02-08		Donald Huppé		Création du service				
		2018-05-02		Donald Huppé		ajout de or c.PlanID = 4
		2018-09-07		Maxime Martel		JIRA MP-699 Ajout de OpertypeID COU
*********************************************************************************************************************/

CREATE PROCEDURE [dbo].[psREPR_RapportCotisationEncaissePourCalculBoniDirecteur_PAR_REP]
    (
		@DateDu datetime
		,@DateAu datetime
    )
...
BEGIN
	...
	--where v2.Rep = 'Siège Social'
	--WHERE V2.ConventionNo like 'T%'
