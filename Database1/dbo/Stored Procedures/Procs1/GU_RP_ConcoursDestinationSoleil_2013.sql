...
Note                :	2010-11-23	Donald Huppé	Créaton à partir de GU_RP_ConcoursDestinationSoleil_2012
						...
						2012-05-18	Donald Huppé	GLPI 7556 : Exclure des recrues qui ne sont pas recrues car il s'agit d'une ré-embauche
*********************************************************************************************************************/

-- exec GU_RP_ConcoursDestinationSoleil_2013_glpi7556 '2011-10-10', '2012-05-09' 

CREATE procedure [dbo].[GU_RP_ConcoursDestinationSoleil_2013] 
	(
