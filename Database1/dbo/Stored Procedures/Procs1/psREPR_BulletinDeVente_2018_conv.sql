...
exec psREPR_BulletinDeVente_2018_conv '2018-01-01','2018-01-07','2017-01-01','2017-01-08'
exec psREPR_BulletinDeVente_2018 '2018-01-01','2018-01-07','2017-01-01','2017-01-08'
--drop proc psREPR_BulletinDeVente_2018

*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[psREPR_BulletinDeVente_2018_conv] (
	@StartDate DATETIME,
	@EndDate DATETIME, 
	...
	from (
		...
		UNION ALL
			...
			from 
				...
				join #tOperTable ot on ot.OperID = o.OperID
				join Un_Unit u on u.UnitID = ct.UnitID
				join Un_Convention c on c.ConventionID = u.UnitID
...
--RETURN
	...
	--SELECT * from #Cotisation where repid= 466292
...
--	@EndDatePrec DATETIME = '2017-01-22'
	...
	select 
		...
		DirecteurActuel = isnull(B.FirstName + ' ' + B.LastName,'ND'),
		...
		Categorie = CASE WHEN V.repid in (
	...
	left JOIN #BossRepActuel M ON V.RepID = M.RepID
