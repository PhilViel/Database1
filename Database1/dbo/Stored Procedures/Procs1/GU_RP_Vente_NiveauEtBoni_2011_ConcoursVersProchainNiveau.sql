...
-- exec GU_RP_Vente_NiveauEtBoni_2011_ConcoursVersProchainNiveau '2010-01-01', '2010-09-27' 

CREATE procedure [dbo].[GU_RP_Vente_NiveauEtBoni_2011_ConcoursVersProchainNiveau] 
	(
...
create table #GrossANDNetUnits (
	...
	select -- Les Rep
		...
		ConsPct =	CASE
					...
					END,
		UniteConcours = SUM ( (Brut - Retraits + Reinscriptions) 
							* case 
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 0 and 1 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 1.25
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 2 and 3 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 1.5
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 4 and 5 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 2
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 6 and 7 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 3
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 8 and 9 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 4
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 10 and 11 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 5
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 12 and 13 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 6
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) between 14 and 15 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 7
								when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) = 16 and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 8
				/*GLPI 4425*/	when dbo.fn_Mo_Age (hb.BirthDate, U.dtfirstdeposit) in (16,17) and c.conventionno like 'I%' and U.dtfirstdeposit between '2010-09-13' and '2010-12-31' then 8
								else 1
								end
							 )
	...
	-- Niveau
	left join GUI.dbo.RepLevel2011 RL24P on (round(NB.UniteConcours,0) >= RL24P.pointFrom and round(NB.UniteConcours,0) < RL24P.PointTo) and (round(NB.ConsPct,0) between RL24P.ConsFrom and RL24P.ConsTo) and RL24P.RepLevel = '24MoisPlus'
	left join GUI.dbo.RepLevel2011 RL24M on (round(NB.UniteConcours,0) >= RL24M.pointFrom and round(NB.UniteConcours,0) < RL24M.PointTo) and (round(NB.ConsPct,0) between RL24M.ConsFrom and RL24M.ConsTo) and RL24M.RepLevel = '24MoisMoins'
	left join GUI.dbo.RepLevel2011 RLREC on (round(NB.UniteConcours,0) >= RLREC.pointFrom and round(NB.UniteConcours,0) < RLREC.PointTo) and (round(NB.ConsPct,0) between RLREC.ConsFrom and RLREC.ConsTo) and RLREC.RepLevel = 'Recrue'
	-- Boni
