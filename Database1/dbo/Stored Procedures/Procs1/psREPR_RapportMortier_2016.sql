...
Nom                 :	psREPR_RapportMortier_2016
Description         :	pour le rapport SSRS "Mortier 2016" (anciennement appelé "Club du Président)
Valeurs de retours  :	Dataset 
Note                :	2015-02-11	Donald Huppé	Créaton à partir de psREPR_RapportMortier_2015
						2015-06-05	Donald Huppé	GLPI 14761 : Gestion du NB
						2015-06-11	Donald Huppé	glpi 14819 : Enlever les directeurs sans vente (Marcelle Payette)
						2015-08-03	Donald Huppé	Ajustement date début agence
*********************************************************************************************************************/

--  exec psREPR_RapportMortier_2016 '2014-10-06', '2015-08-02' , '2013-10-07',  '2014-08-03'

CREATE procedure [dbo].[psREPR_RapportMortier_2016] 
	(
...
create table #VenteDirPrec (
	...
	select 
		...
		AgenceStart = case 
					...
					WHEN repID = 436381 then '2004-09-29' 
					WHEN repID = 149469 then '1990-04-01' 
					WHEN repID = 149489 then '2000-09-01' 
					else AgenceStart
					end,
		Point,
		ConsPct,
