...
Note                :	2010-11-23	Donald Huppé	Créaton à partir de GU_RP_VentesRepConcoursPresident_2011
						2010-12-01	Donald Huppé	Exclure Lise Fournier des recrue
						2011-03-30	Donald Huppé	glpi 5320
						2012-01-12	Donald Huppé	ajout d'un distinct dans les select des 2 curseur de recrue
*********************************************************************************************************************/

--  exec GU_RP_VentesRepConcoursPresident_2012 '2011-10-10', '2012-01-10' , '2010-10-10',  '2011-01-10'

CREATE procedure [dbo].[GU_RP_VentesRepConcoursPresident_2012] 
	(
...
create table #VenteAgVedettePrec (
	...
	DECLARE MyCursor CURSOR FOR
		...
		where 
			...
			and repid <> 594232 -- Exclure Lise Fournier car elle n'est pas recrue
