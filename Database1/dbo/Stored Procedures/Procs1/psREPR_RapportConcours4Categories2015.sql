...
Note                :	2014-05-13	Donald Huppé	Créaton (à partir de GU_RP_VentesExcelRepConcoursUnitBenef)
						2015-06-08	Donald Huppé	GLPI 14761 : Gestion du NB
						2016-11-03	Donald Huppé	jira ti-5468 : Ajustement du calcul de la constance depuis que le concours débute en janvier
													Et programmer la date de début de rep requis pour en faire partie
...
exec psREPR_RapportConcours4Categories2015 '2016-01-01', '2016-10-23', 42

drop proc psREPR_RapportConcours4Categories2015

****************************************************************************************************/
CREATE PROCEDURE [dbo].[psREPR_RapportConcours4Categories2015] (
