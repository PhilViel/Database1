...
Note                :	2010-11-23	Donald Huppé	Créaton à partir de GU_RP_ConcoursDestinationSoleil_2011
						2010-12-01	Donald Huppé	Exclure Lise Fournier des recrue

*********************************************************************************************************************/

-- exec GU_RP_ConcoursDestinationSoleil_2012 '2010-10-10', '2010-11-23' 

CREATE procedure [dbo].[GU_RP_ConcoursDestinationSoleil_2012] 
	(
...
BEGIN
	...
	select -- Les Rep
		...
		Recrue = Case 
					when 
						R.BusinessStart between '2010-10-01' and '2011-09-30' 
						and V.repid <> 594232 -- Exclure Lise Fournier car elle n'est pas recrue
						then 1 
					else 
						0 
					end, 
	...
	GROUP BY
		...
		Case when R.BusinessStart between '2010-10-01' and '2011-09-30' /*>= @StartDate*/ then 1 else 0 end,
