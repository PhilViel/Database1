...
Description         :	Rapport pour le rapport SSRS "DestinationSoleil-Congrès 2014"
Valeurs de retours  :	Dataset 
Note                :	2012-11-15	Donald Huppé	Créaton à partir de GU_RP_ConcoursDestinationSoleil_2013
						2013-04-30	Donald Huppé	GLPI 9568 : ajuster le rmeplacement de "agence Maryse Logelin" par "agence Nouveau-Brunswick"
*********************************************************************************************************************/

-- exec GU_RP_ConcoursDestinationSoleil_2014 '2012-10-08', '2012-10-31' 

CREATE procedure [dbo].[GU_RP_ConcoursDestinationSoleil_2014] 
	(
...
BEGIN
	...
	EXEC SL_UN_RepGrossANDNetUnits NULL, @StartDate, '2013-10-06', 0, 1
