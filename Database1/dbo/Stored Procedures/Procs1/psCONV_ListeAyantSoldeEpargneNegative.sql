...
Code du service        : psCONV_ListeAyantSoldeEpargneNegative
Nom du service        : Liste des Conventions avec épargne negative
But                   : Retourner la liste des conventions ayant un solde d'épargne negatif
Facette                : OPER
...
Exemple d’appel     :   EXEC dbo.psCONV_ListeAyantSoldeEpargneNegative '2015-10-22', '2015-11-10'
...
**********************************************************************************************************************/
CREATE PROCEDURE [dbo].[psCONV_ListeAyantSoldeEpargneNegative] (
	@StartDate     DATE = NULL, 
    @EndDate       DATE = NULL,
...
BEGIN
	...
	-- Liste les conventions ayant un solde négatif d'épargne
	SELECT 
		C.ConventionID,
        C.ConventionNo,
        C.SubscriberID,
