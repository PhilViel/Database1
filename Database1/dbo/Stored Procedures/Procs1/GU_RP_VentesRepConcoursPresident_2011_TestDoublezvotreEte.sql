...
--  exec GU_RP_VentesRepConcoursPresident_2011_TestDoublezvotreEte '2009-10-07', '2010-08-29' , '2008-10-01',  '2009-008-29'
--  drop procedure GU_RP_VentesRepConcoursPresident_2011_TestDoublezvotreEte

CREATE procedure [dbo].[GU_RP_VentesRepConcoursPresident_2011_TestDoublezvotreEte] 
	(
...
create table #VenteAgVedettePrec (
	...
	select 
		...
		BusinessStart,
		Agence,
		Unités_MajoréesEtdoublées = Point
	from #Final
	order by Agence, Rep
