...
Nom                 :	RP_UN_BulletinHebdo_2017
Description         :	Procédure stockée du rapport du Bulletin Hebdomadaire 2016
Valeurs de retours  :	Dataset 
Note                :	2016-12-20			Donald Huppé	    Création
						...
						2017-01-30			Donald Huppé	    jira ti-6071 : les recrues sont les 36 mois. Alors, @QteMoisRecrue = 36 à l'appel de SL_UN_RepGrossANDNetUnits
						2017-01-31			Donald Huppé	    Enlever Hélène Roy
						2017-05-19			Donald Huppé	    Transfert vers agence NB
						...
						2017-09-12			Donald Huppé	    Annuler le changement précédent du jira ti-9148. on va plutot filtrer dans le rapport SSRS
						2017-09-13			Donald Huppé	    ira ti-9148 : (retirer les directeur adjoints Steve Blais #7805 et Chantal Jobin #7186
															    En les rendant inactif
						2017-09-22			Donald Huppé	    jira ti-9247 ajout du parti revenu : (repid 795683)Sophie Asselin
						2017-11-22			Donald Huppé	    jira ti-10165 et 10166
                        2018-10-29          Pierre-Luc Simard   N'est plus utilisée

exec RP_UN_BulletinHebdo_2017_test_jiraTI10165 '2017-11-13','2017-11-19','2016-11-14','2016-11-20',1

drop proc RP_UN_BulletinHebdo_2017_test_jiraTI10165

*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[RP_UN_BulletinHebdo_2017] (
	@StartDate DATETIME,
	@EndDate DATETIME, 
...
set arithabort on
	...
	*/
	...
	/* -- retiré le 2017-11-22 jira ti-10165
...
*/
	...
	where (u.dtFirstDeposit >= '2011-01-01' 
			...
			AND LA.BossID <> 671417 --2017-11-22
	...
	/* -- retiré le 2017-11-22 jira ti-10165
	update #GNUSemaine set BossID = 671417 where BossID = 655109 -- NB
	*/
	...
	update #GNUSemainePrec set BossID = 149489 where BossID = 440176
 	--update #GNUSemainePrec set BossID = 671417 where BossID = 655109 -- NB
	...
	--update #GNUCumul set BossID = 671417 where BossID = 655109 -- NB
	...
	--update #GNUCumulPrec set BossID = 671417 where BossID = 655109 -- NB
	...
	SELECT 
		...
		FirstName,
		BusinessStart,
		RepIsActive = CASE WHEN t.repid in (466100,629154) THEN 0 ELSE RepIsActive END, -- CES 2 REP NE DOIVENT PAS SORTIR DANS LE RAPPORT ALORS JE LES MET INACTIF CAR C'EST UN FILTRE SUR LA PLUPART DES TABLEAU DU RAPPORT
