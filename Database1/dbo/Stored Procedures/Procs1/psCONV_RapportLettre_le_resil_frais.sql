...
Code du service		: psCONV_RapportLettre_le_resil_frais (remplace psConv_RapportLettreResiliation_080)
Nom du service		: Générer la lettre de résiliaton avec frais
But 				: 
Facette				: CONV
...
Exemple d’appel		:	EXEC psCONV_RapportLettre_le_resil_frais '2037998,U-20011219005,U-20011219006'
						EXEC psCONV_RapportLettre_le_resil_frais 'R-20050225003,R-20050225005'
...
****************************************************************************************************/
CREATE PROCEDURE [dbo].[psCONV_RapportLettre_le_resil_frais] @conv varchar(max)
AS
BEGIN
	DECLARE
	...
	SELECT 
		...
		PlanClassification = [dbo].[fnCONV_ObtenirDossierClient](c.subscriberID,1) + '\' + replace(LEFT(CONVERT(VARCHAR, @today, 120), 10),'-','') + '_le_resil_frais'
		,SexRep = hr.SexID
	...
	group by 
		C.SubscriberID, HR.LastName, HR.FirstName, a.address, a.City, a.ZipCode, 
		a.StateName, HS.LastName, HS.FirstName, sex.LongSexName, sex.ShortSexName, hs.LangID, a.CountryID,hr.SexID
END
