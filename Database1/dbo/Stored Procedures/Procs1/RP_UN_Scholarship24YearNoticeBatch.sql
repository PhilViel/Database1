...
Nom                 :	RP_UN_Scholarship24YearNoticeBatch
Description         :	Rapport de fusion Word des avis de 24 ans d'age du bénéficiaire.
...
*********************************************************************************************************************/
CREATE PROCEDURE [dbo].[RP_UN_Scholarship24YearNoticeBatch](
...
BEGIN
	...
	SELECT 
		@DocTypeID = DocTypeID
	FROM CRQ_DocType
	WHERE DocTypeCode = 'Scholarship24Notice'
